    ...
    public partial class InitialSetup : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Carrier", x => x.CarrierGuid);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppraisalDateTime = table.Column<DateTime>(nullable: false),
                    CarrierGuid = table.Column<Guid>(nullable: false),
                    ...
                    TransitStops = table.Column<int>(nullable: false),
                    Width = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Listings", x => x.ListingGuid);
                    table.ForeignKey(
