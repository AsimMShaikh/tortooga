...
namespace TortoogaApp.Migrations
{
    ...
    [Migration("20170117104611_AddedNotificationsTable")]
    partial class AddedNotificationsTable
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("TortoogaApp.Models.Carrier", b =>
                {
                    ...
                    b.Property<Guid>("CarrierBankingDetailsId");

                    b.Property<string>("CarrierShippingItems");
                    ...
                    b.HasIndex("CarrierBankingDetailsId")
                        .IsUnique();

                    b.ToTable("Carriers");
                });

            modelBuilder.Entity("TortoogaApp.Models.CarrierBankingDetails", b =>
                {
                    b.Property<Guid>("CarrierBankingDetailsId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("CarrierBankingDetailsId");

                    b.ToTable("CarrierBankingDetails");
                });

            modelBuilder.Entity("TortoogaApp.Models.CarrierRegistration", b =>
                {
                    b.Property<Guid>("CarrierRegistrationGuid")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("CarrierRegistrationGuid");

                    b.ToTable("CarrierRegistrations");
                });

            modelBuilder.Entity("TortoogaApp.Models.CompanyLogo", b =>
                {
            ...
            modelBuilder.Entity("TortoogaApp.Models.Notifications", b =>
                {
                    ...
                    b.Property<Guid>("RelevantNotificationRefId");

                    b.Property<Guid>("ReleventUserId");
            ...
            modelBuilder.Entity("TortoogaApp.Models.ShipmentStatus", b =>
                {
                    ...
                    b.Property<DateTime>("ShipmentStatusUpdateOn");
            ...
            modelBuilder.Entity("TortoogaApp.Models.Carrier", b =>
                {
                    b.HasOne("TortoogaApp.Models.CarrierBankingDetails", "BankingDetails")
                        .WithOne("Carrier")
                        .HasForeignKey("TortoogaApp.Models.Carrier", "CarrierBankingDetailsId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("TortoogaApp.Models.CompanyLogo", b =>
                {
                    b.HasOne("TortoogaApp.Models.Carrier", "CarrierLogo")
                        .WithMany()
